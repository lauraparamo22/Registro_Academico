...
<div class="card shadow">
    ...
    <div class="card-body">
        <?php if($errors->any()): ?>
            ...
            @endforeach
        <?php endif; ?>
        <form action ="{{ route ('AsistenciaCurso.store')}}" method = "POST"> 
            @csrf
            <div class="form-group">
                <label for="Codigo" class="form-label">Código</label>
                <input type="text" style="width:200px" class="form-control" name = "AttendanceCourseCode" value = "{{old ('AttendanceCourseCode') }}" autocomplete="off" required>
            </div>
            <div class="form-group">
