...
<div class="card shadow">
    ...
    <div class="card-body">
        <?php if($errors->any()): ?>
            ...
            @endforeach
        <?php endif; ?>
        <form action ="{{ route ('NotasCarreras.store')}}" method = "POST"> 
            @csrf
            <div class="form-group">
                <label for="Codigo" class="form-label">Código</label>
                <input type="text" style="width:200px" class="form-control" name = "CareerGradeCode" value = "{{old ('CareerGradeCode') }}" autocomplete="off" required>
            </div>
            <div class="form-group">
                <label for="Nota" class="form-label">Nota</label>
                <input type="number" style="width:80px" class="form-control" name = "Grade" value = "{{old ('Grade') }}" autocomplete="off" required>
            </div>
